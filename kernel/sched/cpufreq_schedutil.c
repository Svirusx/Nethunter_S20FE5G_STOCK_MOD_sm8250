...
static struct governor_attr up_rate_limit_us __maybe_unused = __ATTR_RW(up_rate_limit_us);
static struct governor_attr down_rate_limit_us __maybe_unused = __ATTR_RW(down_rate_limit_us);
